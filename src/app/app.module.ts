...
import { NotificationsComponent } from './components/device/notifications/notifications.component';
import { NotificationOptionComponent } from './components/device/notification-option/notification-option.component';
