...
export class EmployeComponent {
  ...
  constructor(private http:newHttpRequest, private home:HomeService, private activedRoute:ActivatedRoute, private router:Router, private employesvc:EmployesService, private dialog:MatDialog) { }
...
//      this.employe.controls.userid.disable()
  ...
  setBiomtric(){
    ...
    this.employe.controls.userid.disable()
    dialog.afterClosed().subscribe((id_user:any)=>{
      if(id_user){
  ...
  getBiometrics(){
    ...
    this.http.get('employes/device/get?userid='+this.employe.controls.userid.value).then((res:any)=>{
      ...
      this.biometrics = res.filter((e:any)=>e.id_user)
