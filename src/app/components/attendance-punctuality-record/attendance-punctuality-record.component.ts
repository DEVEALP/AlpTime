...
export class AttendancePunctualityRecordComponent { 
  ...
  async donwload_pdf() {
    ...
    var table:addTableInterface = {data:my_records, fontSize: size, color: '#333', settingsHead:{ border: { bottom: 1 }, background: 'transparent' }, cellHeight: heigth, settingsItems: propertys, viewTotal: total}
