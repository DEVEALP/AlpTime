...
import { GeneratorReportPdfV2, ItemConfigInterface, addTableInterface } from 'src/app/services/ReportV2';
...
export class TimeGroupReportComponent {
  ...
  donwload_pdf() {
    ...
    var table:addTableInterface = {data: records, fontSize: size, color: '#333', margin: {top: 10}, settingsHead: { border: { bottom: 1 }, borderColor: '#B4B4B4' }, cellHeight: 8, settingsItems: item_settings}
