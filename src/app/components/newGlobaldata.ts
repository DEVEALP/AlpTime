   ...
   static loadTheme() {
      ...
      if (this.theme) {
         css = `
                ...
                .loading_white.mat-progress-spinner circle, .mat-spinner circle { stroke: #000000 !important; }
                .loading_black.mat-progress-spinner circle, .mat-spinner circle { stroke: #ffffff !important; }
                .hand_line { stroke: white !important; }
                .fill_background { fill: black !important; }
                `;
               } else {
         css = `
         .color { color: #111 !important; } 
                ...
                .loading_white.mat-progress-spinner circle, .mat-spinner circle { stroke: #ffffff !important; }
                .loading_black.mat-progress-spinner circle, .mat-spinner circle { stroke: #000000 !important; }
                 .hand_line { stroke: black !important; }
                .fill_background { fill: white !important; }
             `;
      }
      css += `
       .stroke_color { stroke: `+ this.dataUser.color_primary + ` !important; }
       .fill_color { fill: `+ this.dataUser.color_primary + ` !important; }
       ...
       .mat-calendar-body-in-range::before { background: `+ this.dataUser.color_primary + ` !important; opacity: 0.35; }
       ...
       .mat-calendar-body-disabled{ opacity: 0.4 !important; }
       `;
      if (style) {
         style.innerHTML = css
      } else {
